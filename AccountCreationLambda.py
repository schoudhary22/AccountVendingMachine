...
def deploy_resources(credentials, template, stackname, stackregion, ServiceCatalogUserName, ServiceCatalogUserPassword, CloudTrailCWLogsRetentionTime, CloudTrailLogS3DataEvents, CloudTrailEncryptS3Logs, ConfigSnapshotFrequency, GuardDutyEmailAddress, account_id):
        ...
        try:
            ...
            create_stack_response = client.create_stack(
                ...
                Parameters=[
                    ...
                    {
                        'ParameterKey' : 'CloudTrailCWLogsRetentionTime',
                        'ParameterValue' : CloudTrailCWLogsRetentionTime
                    },
                    {
                        'ParameterKey' : 'CloudTrailLogS3DataEvents',
                        'ParameterValue' : CloudTrailLogS3DataEvents
                    },
                    {
                        'ParameterKey' : 'CloudTrailEncryptS3Logs',
                        'ParameterValue' : CloudTrailEncryptS3Logs
                    ,
                    {
                        'ParameterKey' : 'ConfigSnapshotFrequency',
                        'ParameterValue' : ConfigSnapshotFrequency
                    },
                    {
                        'ParameterKey' : 'GuardDutyEmailAddress',
                        'ParameterValue' : GuardDutyEmailAddress
                    }
...
def main(event,context):
    ...
    CloudTrailCWLogsRetentionTime = event['ResourceProperties']['CloudTrailCWLogsRetentionTime']
    CloudTrailLogS3DataEvents = event['ResourceProperties']['CloudTrailLogS3DataEvents']
    ConfigSnapshotFrequency = event['ResourceProperties']['ConfigSnapshotFrequency']
    GuardDutyEmailAddress = event['ResourceProperties']['GuardDutyEmailAddress']
    CloudTrailEncryptS3Logs = event['ResourceProperties']['CloudTrailEncryptS3Logs']
    ...
    if (event['RequestType'] == 'Create'):
        ...
        if root_id  is not "Error":
            ...
            try:
                ...
                #deploy cloudformation template (Baseline.yml)
                stack = deploy_resources(credentials, template, stackname, stackregion, ServiceCatalogUserName, ServiceCatalogUserPassword, CloudTrailCWLogsRetentionTime, CloudTrailLogS3DataEvents, CloudTrailEncryptS3Logs, ConfigSnapshotFrequency, GuardDutyEmailAddress, account_id)
                print(stack)
